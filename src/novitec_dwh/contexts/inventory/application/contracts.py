"""Contratos de aplicacion del contexto de inventario."""
...
class InventoryExtractionSink(Protocol):
    """Define el contrato de persistencia de la extraccion de inventario."""
