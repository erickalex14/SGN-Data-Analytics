"""Persistencia de extracciones de inventario sobre el sistema de archivos."""
...
class FilesystemInventoryExtractionSink:
    """Persiste la corrida de inventario en una zona raw basada en Parquet."""
    ...
    def finalize(self, summary: InventoryExtractionSummary) -> None:
        ...
        self._manifest_data["summary"] = {
            "repuestos": summary.repuestos,
            "repuestos_chunks": summary.repuestos_chunks,
            "productosinventario": summary.productosinventario,
            "productosinventario_chunks": summary.productosinventario_chunks,
            "orden_repuestos": summary.orden_repuestos,
            "orden_repuestos_chunks": summary.orden_repuestos_chunks,
            "solicitudesrepuesto": summary.solicitudesrepuesto,
            "solicitudesrepuesto_chunks": summary.solicitudesrepuesto_chunks,
            "listascompra": summary.listascompra,
            "listascompra_chunks": summary.listascompra_chunks,
        }
