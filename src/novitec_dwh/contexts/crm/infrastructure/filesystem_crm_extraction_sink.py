"""Persistencia de extracciones CRM sobre el sistema de archivos."""
...
class FilesystemCrmExtractionSink:
    """Persiste la corrida CRM en una zona raw basada en Parquet."""
    ...
    def finalize(self, summary: CrmExtractionSummary) -> None:
        ...
        self._manifest_data["summary"] = {
            ...
            "clientes_chunks": summary.clientes_chunks,
            "empresas": summary.empresas,
            "empresas_chunks": summary.empresas_chunks,
            "sucursalescliente": summary.sucursalescliente,
            "sucursalescliente_chunks": summary.sucursalescliente_chunks,
        }
