"""Persistencia de extracciones tecnicas sobre el sistema de archivos."""
...
class FilesystemTechnicalExtractionSink:
    """Persiste la corrida tecnica en una zona raw basada en Parquet."""
    ...
    def finalize(self, summary: TechnicalExtractionSummary) -> None:
        ...
        self._manifest_data["summary"] = {
            "informes": summary.informes,
            "informes_chunks": summary.informes_chunks,
            "informefotos": summary.informefotos,
            "informefotos_chunks": summary.informefotos_chunks,
            "equipos": summary.equipos,
            "equipos_chunks": summary.equipos_chunks,
            "equiposseries": summary.equiposseries,
            "equiposseries_chunks": summary.equiposseries_chunks,
            "tiposdispositivo": summary.tiposdispositivo,
            "tiposdispositivo_chunks": summary.tiposdispositivo_chunks,
            "tiposservicio": summary.tiposservicio,
            "tiposservicio_chunks": summary.tiposservicio_chunks,
            "marcas": summary.marcas,
            "marcas_chunks": summary.marcas_chunks,
            "credencialesequipo": summary.credencialesequipo,
            "credencialesequipo_chunks": summary.credencialesequipo_chunks,
        }
