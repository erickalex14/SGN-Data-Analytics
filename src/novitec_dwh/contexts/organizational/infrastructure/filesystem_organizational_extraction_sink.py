"""Persistencia de extracciones organizacionales sobre sistema de archivos."""
...
class FilesystemOrganizationalExtractionSink:
    """Persiste corrida organizacional en zona raw basada en Parquet."""

    def __init__(self, base_path: Path) -> None:
        """Recibe carpeta raiz donde se almacenaran corridas."""
    ...
    def start(self, extraction_id: str, started_at: datetime) -> None:
        """Inicializa directorios y metadatos base de corrida."""
    ...
    def write(self, dataset_name: str, chunk_number: int, records: list[object]) -> Path:
        """Escribe lote indicado en formato Parquet."""
    ...
    def finalize(self, summary: OrganizationalExtractionSummary) -> None:
        """Genera manifiesto final de corrida en JSON."""
        ...
        self._manifest_data["summary"] = {
            ...
            "sucursales_chunks": summary.sucursales_chunks,
            "roles": summary.roles,
            "roles_chunks": summary.roles_chunks,
            "gruposacceso": summary.gruposacceso,
            "gruposacceso_chunks": summary.gruposacceso_chunks,
            "usuarios": summary.usuarios,
            "usuarios_chunks": summary.usuarios_chunks,
            "usuariosucursales": summary.usuariosucursales,
            "usuariosucursales_chunks": summary.usuariosucursales_chunks,
            "permisosgrupo": summary.permisosgrupo,
            "permisosgrupo_chunks": summary.permisosgrupo_chunks,
            "permisosusuario": summary.permisosusuario,
            "permisosusuario_chunks": summary.permisosusuario_chunks,
        }
    ...
    def _normalize_record(self, record: object) -> dict[str, Any]:
        """Convierte entidad a diccionario serializable para Parquet."""
    ...
    def _normalize_value(self, value: Any) -> Any:
        """Normaliza valores complejos conservando semantica analitica."""
    ...
    def _build_dataframe(self, rows: list[dict[str, Any]]) -> pl.DataFrame:
        """Construye DataFrame robusto para columnas con tipos mezclados."""
    ...
    def _coerce_mixed_columns_to_string(
        ...
        """Convierte a texto columnas cuyo tipo varia entre filas."""
