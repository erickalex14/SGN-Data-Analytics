"""Contratos de aplicacion del contexto de garantias."""
...
class WarrantyExtractionSink(Protocol):
    """Define el contrato de persistencia de la extraccion de garantias."""
